...
1. **公共限时图床** - 提供的临时图床，带过期时间
2. **自建图床** - 使用你自己的 Cloudflare R2 或 S3
3. **Base64 编码** - 图片直接嵌入 Markdown（不推荐大图）
...
配置指南请参考 [公共图床配置指南](docs/SETUP_GUIDE.md)，详细的安全配置说明请参考 [安全配置文档](docs/SECURITY.md)。
